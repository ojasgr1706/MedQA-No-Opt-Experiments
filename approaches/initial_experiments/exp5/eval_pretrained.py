...
def main():
    ...
    for checkpoint in range(10,51,10):
        Path = f'{args.output_dir}{model_name}_resp_epoch{checkpoint}.pth'
    ...
    iodf.to_csv(f"{args.output_dir}exp5_pretrain_training_io.csv")
    results_df.to_csv(f"{args.output_dir}exp5_pretrain_training_scores.csv")
