...
def main():
    ...
    for checkpoint in range(10,71,10):
        Path = f'{args.output_dir}{model_name}_finetuned_exp4_epoch{checkpoint}.pth'
    ...
    iodf.to_csv(f"{args.output_dir}exp4_finetune_io.csv")
    results_df.to_csv(f"{args.output_dir}exp4_finetune_scores.csv")
