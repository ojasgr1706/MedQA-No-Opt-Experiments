...
def main():
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument("--train_data_resp", help="Add input data files (single file name or list fo files in the format : [a,b,c,...]. The files in the list will be concatenated before being used as training data)", required=True, type=str_or_list)
    parser.add_argument("--train_data_endo", help="Add input data files (single file name or list fo files in the format : [a,b,c,...]. The files in the list will be concatenated before being used as training data)", required=True, type=str_or_list)
    ...
    resp_dataset = load_dataset('text',data_files={'test': args.train_data})
